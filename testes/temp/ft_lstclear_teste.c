// Create a test function to delete the content
...
// Create a function to print the contents of the list
...
// Create a function to clear the list and test ft_lstclear
